...
public class AdminFrame extends JFrame {
	...
	public void registerQuestion(final Question q) {
		...
		if (Main.FAST_MONEY) {
			...
			revealAllButton.setText("Duplicate");
		}
		...
		if (Main.FAST_MONEY) {
			...
			// disable duplicate answers
			if (slot >= 5) {
				Text.debug("ansCache = " + ansCache[slot-5] + "\n");
				Text.debug(ansButton10.getText() + "\n");
				Text.debug(ansButton9.getText() + "\n");
				Text.debug(ansButton8.getText() + "\n");
				Text.debug(ansButton7.getText() + "\n");
				Text.debug(ansButton6.getText() + "\n");
				Text.debug(ansButton5.getText() + "\n");
				Text.debug(ansButton4.getText() + "\n");
				Text.debug(ansButton3.getText() + "\n");
				Text.debug(ansButton2.getText() + "\n");
				Text.debug(ansButton1.getText() + "\n");
				
				switch(q.answerCount()) {
				case 10: if (ansButton10.getText().equalsIgnoreCase(ansCache[slot-5])) ansButton10.setEnabled(false);
				case 9: if (ansButton9.getText().equalsIgnoreCase(ansCache[slot-5])) ansButton9.setEnabled(false); 
				case 8: if (ansButton8.getText().equalsIgnoreCase(ansCache[slot-5])) ansButton8.setEnabled(false); 
				case 7: if (ansButton7.getText().equalsIgnoreCase(ansCache[slot-5])) ansButton7.setEnabled(false); 
				case 6: if (ansButton6.getText().equalsIgnoreCase(ansCache[slot-5])) ansButton6.setEnabled(false); 
				case 5: if (ansButton5.getText().equalsIgnoreCase(ansCache[slot-5])) ansButton5.setEnabled(false); 
				case 4: if (ansButton4.getText().equalsIgnoreCase(ansCache[slot-5])) ansButton4.setEnabled(false); 
				case 3: if (ansButton3.getText().equalsIgnoreCase(ansCache[slot-5])) ansButton3.setEnabled(false); 
				case 2: if (ansButton2.getText().equalsIgnoreCase(ansCache[slot-5])) ansButton2.setEnabled(false); 
				case 1: if (ansButton1.getText().equalsIgnoreCase(ansCache[slot-5])) ansButton1.setEnabled(false); break;
				}
			}
		}
